...
// -- Returns a 2D Metal Texture
@implementation MTKTextureLoader(HDR)
...
- (id<MTLTexture>_Nullable) newTextureFromRadianceFile:(NSString *_Nullable)fileName
    ...
    // Case sensitive file names if the image is stored in the Resources folder.
